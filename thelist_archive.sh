...
for date in $ALLDATES; do
  case $date in
    ...
    2015-10-31)
      ...
      ;;
    2015-11-*)
      # fix commit date for rest of 2015-11 being overwritten with 2015-12
      do_date $date $(echo $date | sed 's/2015-11/2015-12/')
      ;;
    2017-12-31)
      do_date $date $date
    ...
    1995-06-06 | 1995-06-14 | 1996-70-12 | 1998-01-01 | 1998-01-04 | 1998-01-05 | \
                 ...
                 2015-11-08 | 2015-11-12 | 2015-11-13 | 2015-11-14 | 2015-11-26 | \
                 2017-01-01 | 2017-01-02 | 2017-01-03 | 2017-01-04 | 2017-01-05 | \
                 2019-00-01 | 2019-00-02 | 2010-10-01) # 2010-10-01 is an empty file
